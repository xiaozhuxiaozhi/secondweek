(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'request-promise', 'path'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('request-promise'), require('path'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.requestPromise, global.path);
        global.indexModel = mod.exports;
    }
})(this, function (exports, _requestPromise, _path) {
    'use strict';
